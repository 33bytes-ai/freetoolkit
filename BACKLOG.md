...
| 24.00 | Remove fabricated testimonials with stock avatar photos | 8 | 3 | 1 | pending |
...
| 18.00 | Derive contact email from site config instead of hardcoding it | 6 | 3 | 1 | pending |
...
| 15.75 | Bundle a font so OG image generation doesn't silently fail | 7 | 4 | 1 | pending |
| 15.00 | Fix working-capital-calculator and current-ratio-calculator test/widget mismatch | 5 | 3 | 1 | pending |
| 15.00 | Audit remaining pages/templates for other placeholder or hardcoded content | 5 | 3 | 1 | pending |

...
if (typeof document !== "undefined") {
  function run() {
    ...
    var fmt$ = function(v) { return (v >= 0 ? "+" : "-") + window.FTK.cur() + Math.abs(Math.round(v)).toLocaleString("en-US"); };
    ...
    var e4 = document.getElementById("nrr-out-ending"); if (e4) e4.textContent = window.FTK.cur() + Math.round(ending).toLocaleString("en-US");
